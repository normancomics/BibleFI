...
contract BibleFiSpandexAdvisory is Ownable2Step, ReentrancyGuard {
    ...
    struct Advisory {
        ...
        uint16   competitivenessScore;  // 0-100 vs bankr.bot-style benchmark
        int32    outputDeltaBps;        // BWTYA output delta vs best-price route
        bool     biblicalPolicyPass;    // whether route passed BibleFi policy guardrails
        bytes32  policyHash;            // hash of policy details off-chain for attestability
        bool     sabbathAutonomous;     // true when generated by Sunday autonomous mode
    ...
    event AdvisoryCompetitiveBenchmarked(
        uint256 indexed advisoryId,
        uint16 competitivenessScore,
        int32 outputDeltaBps,
        bool biblicalPolicyPass,
        bytes32 policyHash
    );
     ...
     * @param competitivenessScore Competitiveness score vs best-price bots (0–100)
     * @param outputDeltaBps       BWTYA output delta vs best-price route in bps
     * @param biblicalPolicyPass   Whether selected route passed BibleFi policy checks
     * @param policyHash           Hash of policy evaluation payload for audit replay
     * @param sabbathAutonomous    Whether advisory was generated in Sunday autonomous mode
    ...
    function recordAdvisory(
        ...
        require(competitivenessScore <= 100, "BibleFiSpandexAdvisory: invalid competitiveness");
        ...
        advisories[advisoryId] = Advisory({
            ...
            outputDeltaBps:      outputDeltaBps,
            biblicalPolicyPass:  biblicalPolicyPass,
            policyHash:          policyHash,
            sabbathAutonomous:   sabbathAutonomous,
        ...
        emit AdvisoryCompetitiveBenchmarked(
            advisoryId,
