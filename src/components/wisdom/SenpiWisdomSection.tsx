    ...
    <div className="my-8">
      ...
      <div className="bg-black/80 border-2 border-scripture p-4 rounded-lg mb-6">
        ...
        <p className="mb-4 text-white">
          Not hearing sounds? Test your device compatibility by clicking these buttons below.
          Each button plays a different retro arcade sound effect.
        </p>
        ...
        <div className="bg-black/50 border border-scripture p-3 mt-4 rounded text-white text-sm">
          <h4 className="font-bold mb-1">Troubleshooting Tips:</h4>
          <ul className="list-disc pl-5">
            <li>Make sure your device volume is turned up</li>
            <li>Some browsers require user interaction before playing audio</li>
            <li>iOS/iPad devices may have additional restrictions on audio playback</li>
            <li>Try clicking the buttons multiple times</li>
          </ul>
        </div>
      </div>
      
      {/* Character demonstrates sound */}
      <div className="mb-6">
        <PixelCharacter 
          character="solomon" 
          message="Click me to hear the Wisdom sound effect! The Bible says: 'Like the noise of chariots on the tops of mountains shall they leap.' Joel 2:5"
          soundEffect={true}
        />
      </div>
