      ...
      <main className="container mx-auto px-4 py-8">
        <section className="text-center mb-12">
          ...
          <p className="text-xl max-w-2xl mx-auto mt-4">
            Manage your cryptocurrency taxes with BIBLICAL wisdom and AI-powered strategies.
          </p>
        </section>
        ...
        <Tabs defaultValue="ai-advisor" className="mb-8">
          <TabsList className="bg-scripture/40 border border-ancient-gold/50 p-1 mb-6">
            <TabsTrigger value="ai-advisor" className="data-[state=active]:bg-green-900/70 text-ancient-gold">
              <Brain className="w-4 h-4 mr-2" />
              AI Tax Advisor
            </TabsTrigger>
            <TabsTrigger value="tax-tools" className="data-[state=active]:bg-green-900/70 text-ancient-gold">
              <Calculator className="w-4 h-4 mr-2" />
              Tax Tools
            </TabsTrigger>
            <TabsTrigger value="saving-tips" className="data-[state=active]:bg-green-900/70 text-ancient-gold">
